 ...
 * Sign-up page — register with name, email, password or continue with Google.
 *
 * Auth.js v5: signIn() from "next-auth/react" is identical on the client.
 */
...
import {
  ...
  User, Chrome, Loader2, CheckCircle2,
} from "lucide-react";
...
export default function SignUpPage() {
  ...
  async function handleSignUp(e: React.FormEvent) {
    ...
    try {
      ...
      if (result?.error) {
        setSuccess(true); // account exists, just needs manual sign-in
      } else {
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-[#111827] border border-[#1e2d45] rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-1 text-sm">Start organising your PDFs today</p>
          </div>
